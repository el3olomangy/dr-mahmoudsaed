    ...
    for unit in units_raw:
        ...
        for lec in lectures_raw:
            lectures.append(LectureResponse(
                ...
                video_url=lec.get("video_url") if (is_enrolled or current_user.get("role") in ["teacher", "assistant"]) else None,
                pdf_url=lec.get("pdf_url") if (is_enrolled or current_user.get("role") in ["teacher", "assistant"]) else None,
                order=lec["order"],
